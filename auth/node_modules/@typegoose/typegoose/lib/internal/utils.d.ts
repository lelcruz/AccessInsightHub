 ...
 */
export declare function mergeSchemaOptions<U extends AnyParamConstructor<any>>(value: mongoose.SchemaOptions | undefined, cl: U): mongoose.SchemaOptions<unknown, {}, {}, {}, {}, mongoose.Document<unknown, {}, unknown> & Omit<{
 ...
 */
export declare function warnNotMatchingExisting(fromName: string, clName: string, property: string): void;
/**
 ...
 */
export declare function isGlobalCachingEnabled(): boolean;
/**
 * Helper function to check if caching is enabled globally AND by options
 * @param opt The caching option (from IModelOptions)
 * @returns "true" if caching is enabled or "false" if disabled
 */
export declare function isCachingEnabled(opt: boolean | undefined): boolean;
