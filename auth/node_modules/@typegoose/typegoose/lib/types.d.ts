 ...
 * ```
 */
export type DocumentType<T, QueryHelpers = BeAnObject> = mongoose.Document<unknown, QueryHelpers, T> & mongoose.Require_id<T> & IObjectWithTypegooseFunction;
/**
 ...
 */
export type ModelType<T, QueryHelpers = BeAnObject> = mongoose.Model<T, // raw doc type
