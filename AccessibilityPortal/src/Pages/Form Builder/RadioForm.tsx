...
//Component for creating and managing a radio button form.
function RadioForm(props: RadioFormProps) {
    ...
    // Effect hook for loading data on component mount and when 'reload' state changes
    useEffect(() => {
    ...
    // Handles the change of an option, updates Firebase, and state
    ...
    // Rendering the form with radio button options
    return (
        <form>
